        ...
        <div class="right-content">
            <form action="">
                <div class="content-nav">
                    ...
                    <a class="inline-block active-nav" href="javascript:;">积分获取</a>
                        ...
                        @foreach($data as $value)
                            <div class="one-item">
                                <div class="one-item-title">
                                    ...
                                    <span style="margin-right: 0;">@if($value->status == 0) 已处理 @elseif($value->status == 1) 未处理 @else 已撤销 @endif</span>
                                </div>
                                <div class="one-item-content">
                                    ...
                                    @if($value['status'] == 1)
                                        <div class="operation">
                                            @if($value->handle == 0)
                                            <a class="inline-block" href="{{ route('member.integral.show', ['id' => $value->id]) }}" style="color: #0064bc">
