...
@section('title','用户中心-产品研发榜')

@section('uc_here', '产品研发榜')
            ...
            <div id="right-wrapper">
                ...
                @if($is_register_company_info)
                    ...
                    <div class="go-release-btn">
                        <a href="{{route('member.publishing.product.create')}}">
                            <span>发布需求</span>
                                ...
                                <div class="one-item">
                                    ...
                                    <div class="one-item-content">
                                        <p>
                                            ...
                                            {{$product_config['cooperation'][$value['cooperation_id']]}} |
                                            {{$product_config['game_type'][$value['game_type_id']]}} |
                                        ...
                                        @if($value['status'] != -1)
                                        <div class="operation">
                                            <a class="inline-block" href="{{ route('member.publishing.product.update', ['id' => $value->id]) }}">
    ...
    <script>
        $('.del').click(function(){
            if(confirm("确定要删除数据")){
                ...
                $.ajax({
                    url:"{{ route('member.publishing.product.destroy') }}",
                    type:"POST",
                    dataType : 'json',
