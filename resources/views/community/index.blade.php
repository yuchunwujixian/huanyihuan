...
@section('content')
    ...
    <div class="container">
        ...
        <form class="say-form" action="{{route('community.post.store')}}" method="post">
            {{csrf_field()}}
            <textarea class="say-somthing" placeholder="说点什么吧！" name="content" style="width: 100%;background-color: #FFF"></textarea>
            <div class="deliver-something" style="padding-top: 10px; height: 100%">
                @if(Auth::check())
                <div class="img-upload">
                    <input id="upload_company_logo" class="upload_button" style="padding: 5px 0 0 10px" type="button" value="本地上传"/>
                ...
                <div class="comment-operation">
                    ...
                    @if(Auth::check())
                        ...
                        <div class="inline-block discuss">
                            <i class="icon iconfont icon-pinglun"></i> 评论（{{$post->commentsInfo->count()}}）
                        </div>
