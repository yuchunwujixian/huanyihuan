$(function () {
    ...
    $(".gametype").click(function () {
        ...
        if (selectData.gametype[0] !== $(this).html()) {
            selectData.gametype[0] = $(this).html();
            $(".gametype").removeClass("square").addClass("square-o")
            $(this).removeClass("square-o").addClass("square");
        } else {
            selectData.gametype.splice(0, 1);
            $(this).removeClass("square").addClass("square-o");
        }
        renderParameters();
    })
